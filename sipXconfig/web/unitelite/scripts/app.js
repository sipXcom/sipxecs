...
var uniteWeb = angular.module('uw', ['ngAnimate', 'ngSanitize', 'ngCookies', 'ngRoute', 'config', 'emoji', 'underscore', 'LocalStorageModule', 'notify', 'xml', 'dragAndDrop', 'ngOrderObjectBy', 'angularFileUpload', 'angularUtils.directives.dirPagination']);
